                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <form action="<?= base_url('laporan/generate_complaint_selesai'); ?>" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row justify-content-center">
                                            <form action="<?= base_url('laporan/complaint-print-selesai/'); ?>" method="post">
                                                <input type="hidden" value="<?= $cmp->id; ?>" name="id">
