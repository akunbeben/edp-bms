...
<tr>
<td>No. Doc: <strong>EDPREP02200001</strong></td>
<td>Dibuat oleh: <strong>Rizqi Isfahani</strong></td>
</tr>

<tr>
<td>Dibuat pada: <strong><?= date('d M Y', time()); ?></strong></td>
...
<th style="text-align: center">Di input pada</th>
<th style="text-align: center">Di input oleh</th>
<th style="text-align: center">Stample & TTD</th>
</tr>
...
<td style="text-align: center"><?= date('d M Y', strtotime($bdy->created_at)); ?></td>
