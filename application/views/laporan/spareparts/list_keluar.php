                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <form action="<?= base_url('laporan/generate_spareparts_keluar'); ?>" method="post">
                    ...
                    <div class="card-body">
                        <table id="complaintTable" class="table table-hover table-bordered">
                            ...
                            <?php foreach ($spareparts as $spr) : ?>
                                <tr>
                                    <td><?= $spr->doc_no; ?></td>
                                    <td><?= $spr->created_at; ?></td>
                                    <td><?= $spr->created_by; ?></td>
                                    <td>
                                        <div class="row justify-content-center">
                                            <form action="<?= base_url('laporan/print-spareparts-keluar/'); ?>" method="post">
                                                <input type="hidden" value="<?= $spr->id; ?>" name="id">
