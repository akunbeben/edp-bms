                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <form action="<?= base_url('laporan/generate_kunjungan'); ?>" method="post">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row justify-content-center">
                                            <form action="<?= base_url('laporan/print-kunjungan/'); ?>" method="post">
                                                <input type="hidden" value="<?= $kj->id; ?>" name="id">
