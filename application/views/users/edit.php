    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <form action="<?= base_url('users/edit/') . $users->id; ?>" method="post">
                            <div class="form-group">
                                ...
                                <select class="form-control select-produk" id="teknisi" name="teknisi" required>
                                    ...
                                    <option value="<?= $tk->id; ?>" <?= $tk->id == $users->teknisi ? 'selected' : ''; ?>><?= $tk->nama; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="level" name="level" required>
                                    <option value="1" <?= $users->level == 1 ? 'selected' : ''; ?>>Administrator</option>
                                    <option value="2" <?= $users->level == 2 ? 'selected' : ''; ?>>Teknisi</option>
                                </select>
                            </div>
